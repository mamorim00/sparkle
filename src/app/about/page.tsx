    ...
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <section className="max-w-6xl mx-auto py-16 px-6 grid md:grid-cols-2 gap-10">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-cyan-50 shadow-lg rounded-xl p-8 border-2 border-blue-200">
          <h3 className="text-2xl font-bold mb-6 text-gray-900">{t('aboutPage.howItWorks')}</h3>
          <ul className="space-y-4">
            <li className="flex items-start gap-3">
              <span className="text-2xl">✅</span>
              <span className="text-gray-700">{t('aboutPage.step1')}</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-2xl">✅</span>
              <span className="text-gray-700">{t('aboutPage.step2')}</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-2xl">✅</span>
              <span className="text-gray-700">{t('aboutPage.step3')}</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-2xl">✅</span>
              <span className="text-gray-700">{t('aboutPage.step4')}</span>
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-12 text-gray-900">{t('aboutPage.ourValues')}</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-white border-2 border-blue-200 rounded-xl shadow-lg hover:shadow-xl hover:border-blue-400 transition-all">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">{t('aboutPage.trustSafety')}</h3>
              <p className="text-gray-700">{t('aboutPage.trustSafetyDesc')}</p>
            </div>
            <div className="p-8 bg-white border-2 border-blue-200 rounded-xl shadow-lg hover:shadow-xl hover:border-blue-400 transition-all">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-3xl">⭐</span>
              </div>
              <h3 className="text-xl font-bold mb-3 text-gray-900">{t('aboutPage.qualityService')}</h3>
              <p className="text-gray-700">{t('aboutPage.qualityServiceDesc')}</p>
            </div>
            <div className="p-8 bg-white border-2 border-blue-200 rounded-xl shadow-lg hover:shadow-xl hover:border-blue-400 transition-all">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-3xl">🤝</span>
              </div>
              <h3 className="text-xl font-bold mb-3 text-gray-900">{t('aboutPage.community')}</h3>
              <p className="text-gray-700">{t('aboutPage.communityDesc')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white text-center py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold mb-4">{t('aboutPage.readyToStart')}</h2>
          <p className="text-xl mb-8">{t('aboutPage.joinToday')}</p>
